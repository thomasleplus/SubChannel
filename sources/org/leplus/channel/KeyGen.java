...
public final class KeyGen
	...
	private JTextField privField;
   	...
   	public KeyGen() {
		...
		mainFrame = new JFrame("Génération de clés DSA");
		
		JPanel mainPanel = new JPanel();
		mainPanel.setLayout(new GridLayout(0, 1));
		
		JPanel sizePanel = new JPanel();
		JLabel sizeLabel = new JLabel("Taille de clé désirée : ");
	...
	public void actionPerformed(ActionEvent ae) {
		try {
			int size = (Integer.parseInt((String)sizeCombo.getSelectedItem()) - 512) / 64;
 			JOptionPane.showMessageDialog(mainFrame, "<html><b>La génération de vos clés DSA peut prendre quelques minutes<br>(selon la rapidité de votre ordinateur).<br>Cliquez sur OK pour continuer.</b></html>");
			...
			privStream.close();
			JFrame msgFrame = new JFrame("Résumé");
 			JPanel msgPanel = new JPanel();
			String info = "<html><b>Informations sur les clés :</b><br><br>";
