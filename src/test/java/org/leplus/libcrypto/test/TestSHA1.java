...
public final class TestSHA1
{
	...
	public void test()
		...
		b = test("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq", 1, "84983e441c3bd26ebaae4aa1f95129e5e54670f1") ? b : false;
		b = test("a", 1000000, "34aa973cd4c4daa4f61eeb2bdbad27316534016f") ? b : false;
		assertTrue(b);
	}
	
	private boolean test(String vector, int loop, String result)
		throws Exception {
