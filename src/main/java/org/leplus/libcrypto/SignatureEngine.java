...
public abstract class SignatureEngine {
  ...
  /**
   * Remet la machine dans son état initial (garde en mémoire le mode génération ou vérification et
  ...
  /**
   * Génère la signature des octets lus et remet la machine dans son état initial (garde en mémoire
   * le mode génération ou vérification et la clé correspondante).
   *
   * @param key la clé privée.
   * @return la signature.
   */
  ...
  /**
   * Lit au plus le nombre donné d'octets du tableau en commençant à l'indice donné.
   *
   * @param bytes le tableau d'octets.
  ...
  /**
   * Vérifie la signature des octets lus et remet la machine dans son état initial (garde en mémoire
   * le mode génération ou vérification et la clé correspondante).
   *
   * @param key la clé publique.
   * @param signature the signature.
