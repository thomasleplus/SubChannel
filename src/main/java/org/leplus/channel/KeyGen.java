...
public final class KeyGen implements ActionListener {
  ...
  public void actionPerformed(final ActionEvent ae) throws NumberFormatException {
    try (ObjectOutputStream pubStream =
            new ObjectOutputStream(new FileOutputStream(pubField.getText()));
        ObjectOutputStream privStream =
            new ObjectOutputStream(new FileOutputStream(privField.getText()))) {
